                ...
                <div class="card-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" name="project_name" value="<?= $portfolio['project_name'] ?>" class="form-control <?php echo (isset($errors['project_name_error'])) ? "is-invalid" : "" ?>" id="project_name" placeholder="Project name" autofocus>
                            <!-- project_name error -->
                        ...
                        <div class="form-group my-3">
                            ...
                            <select name="category" id="category" class="form-select <?php echo (isset($errors['category_error'])) ? "is-invalid" : "" ?>">
                                ...
                                <option value="1" <?= ($portfolio['category'] == 1) ? "selected" : "" ?>>App</option>
                                <option value="2" <?= ($portfolio['category'] == 2) ? "selected" : "" ?>>Card</option>
                                <option value="3" <?= ($portfolio['category'] == 3) ? "selected" : "" ?>>Web</option>
                            </select>
                            <!-- category error -->
                        ...
                        <div class="form-group my-3">
                            ...
                            <input type="text" name="client" value="<?= $portfolio['client'] ?>" class="form-control <?php echo (isset($errors['client_error'])) ? "is-invalid" : "" ?>" id="client" placeholder="Client">
                            <!-- client error -->
                            <?php echo (isset($errors['client_error'])) ? "<span class='text-danger'>" . $errors['client_error'] . "</span>" : "" ?>
                        </div>
                        <div class="form-group my-3">
                            <label for="project_date" class="form-label">Project date</label>
                            <input class="form-control" type="date" name="project_date" value="<?= $portfolio['project_date'] ?>" id="project_date">
                            <!-- project_date error -->
                            <?php echo (isset($errors['project_date_error'])) ? "<span class='text-danger'>" . $errors['project_date_error'] . "</span>" : "" ?>
                        </div>
                        <div class="form-group my-3">
                            <label for="project_url" class="form-label">Project url</label>
                            <input class="form-control <?php echo (isset($errors['project_url_error'])) ? "is-invalid" : "" ?>" name="project_url" value="<?= $portfolio['project_url'] ?>" id="project_url" placeholder="Project url">
                            <!-- project_url error -->
                            <?php echo (isset($errors['project_url_error'])) ? "<span class='text-danger'>" . $errors['project_url_error'] . "</span>" : "" ?>
                        </div>
                        <div class="form-group my-3">
                            <label for="project_description" class="form-label">Project description</label>
                            <textarea class="form-control <?php echo (isset($errors['project_description_error'])) ? "is-invalid" : "" ?>" rows="5" name="project_description" id="project_description" placeholder="Project description"><?= $portfolio['project_description'] ?></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            if ($portfolio['image']) { ?>
                                <br>
                                <img src="<?= USER_IMAGE_SITE_PATH . 'portfolio/' . $portfolio['image'] ?>" width="100" alt="<?= $portfolio['image'] ?>">
                            <?php } ?>
                        </div>
