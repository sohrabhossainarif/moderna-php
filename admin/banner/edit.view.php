                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" value="<?= $banner['title'] ?>" class="form-control <?php echo (isset($banner_errors['title_error'])) ? "is-invalid" : "" ?>" id="title" placeholder="Title" autofocus>
                            <!-- title error -->
                            <?php echo (isset($banner_errors['title_error'])) ? "<span class='text-danger'>" . $banner_errors['title_error'] . "</span>" : "" ?>
                        </div>
                        <div class="form-group my-3">
                            <label for="description" class="form-label">Description</label>
                            <textarea class="form-control <?php echo (isset($banner_errors['description_error'])) ? "is-invalid" : "" ?>" name="description" id="description" rows="5" placeholder="Description"><?= $banner['description'] ?></textarea>
                            <!-- description error -->
                        ...
                        <div class="form-group my-3">
                            ...
                            <input type="text" name="btn_text" value="<?= $banner['btn_text'] ?>" class="form-control <?php echo (isset($banner_errors['btn_text_error'])) ? "is-invalid" : "" ?>" id="btn_text" placeholder="Button text">
                            <!-- button text error -->
                        ...
                        <div class="form-group my-3">
                            ...
                            <input type="text" name="btn_url" value="<?= $banner['btn_url'] ?>" class="form-control <?php echo (isset($banner_errors['btn_url_error'])) ? "is-invalid" : "" ?>" id="btn_url" placeholder="Button url">
                            <!-- button url error -->
