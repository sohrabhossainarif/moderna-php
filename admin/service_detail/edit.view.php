...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 mb-4 order-0">
            <div class="card mb-4">
                <h5 class="card-header">Edit Service Detail</h5>
                <div class="card-body">
                    <?php
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" value="<?= $service_details['title'] ?>" class="form-control <?php echo (isset($errors['title_error'])) ? "is-invalid" : "" ?>" id="title" placeholder="Title" autofocus>
                            <!-- title error -->
                        ...
                        <div class="form-group my-3">
                            ...
                            <textarea class="form-control <?php echo (isset($errors['description_error'])) ? "is-invalid" : "" ?>" name="description" id="description" rows="5" placeholder="Description"><?= $service_details['description'] ?></textarea>
                            <!-- description error -->
                        ...
                        <div class="mb-3">
                            ...
                            if ($service_details['image']) { ?>
                                <br>
                                <img src="<?= USER_IMAGE_SITE_PATH . 'service/' . $service_details['image'] ?>" width="100" alt="<?= $service_details['image'] ?>">
                            <?php } ?>
                        </div>
