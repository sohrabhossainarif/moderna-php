                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) { ?>
                                    <tr>
                                        <td><?= $i++ ?></td>
                                        <td>
                                            <img src="<?= USER_IMAGE_SITE_PATH . 'service/' . $row['image'] ?>" alt="<?= $row['image'] ?>" width="50">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="service_details.php?id=<?= $row['id'] ?>"><i class='bx bx-show'></i> Show</a>
