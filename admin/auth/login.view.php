                    ...
                    <div class="card-body">
                        ...
                        <form class="mb-3" action="" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control <?php echo (isset($user_error['email_error'])) ? "is-invalid" : "" ?>" id="email" name="email" placeholder="Enter your email" autofocus />
                                <!-- email error -->
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" class="form-control <?php echo (isset($user_error['password_error'])) ? "is-invalid" : "" ?>" name="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" type="submit" name="subimt">Sign in</button>
                            </div>
                        </form>
