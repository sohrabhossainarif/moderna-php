                    ...
                    <div class="card-body">
                        ...
                        <form class="mb-3" action="" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?php echo (isset($user_error['name_error'])) ? "is-invalid" : "" ?>" id="name" name="name" placeholder="Enter your name" autofocus>
                                <!-- name error -->
                                <?php echo (isset($user_error['name_error'])) ? "<span class='text-danger'>" . $user_error['name_error'] . "</span>" : "" ?>
                            </div>
                            <div class="mb-3">
                                <label for="email" class="form-label">Email</label>
                                <input type="email" class="form-control <?php echo (isset($user_error['email_error'])) ? "is-invalid" : "" ?>" id="email" name="email" placeholder="Enter your email">
                                <!-- email error -->
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" class="form-control <?php echo (isset($user_error['password_error'])) ? "is-invalid" : "" ?>" name="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;">
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="confirm_password" class="form-control <?php echo (isset($user_error['confirm_password_error'])) ? "is-invalid" : "" ?>" name="confirm_password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;">
                                    <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control <?php echo (isset($user_error['avatar_error'])) ? "is-invalid" : "" ?>" id="avatar" name="avatar">
                                <!-- avatar error -->
