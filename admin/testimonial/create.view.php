...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 mb-4 order-0">
            <div class="card mb-4">
                <h5 class="card-header">Create new Testimonial</h5>
                <div class="card-body">
                    <?php
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group my-3">
                            ...
                            <textarea class="form-control <?php echo (isset($errors['comment_error'])) ? "is-invalid" : "" ?>" name="comment" id="comment" rows="5" placeholder="Comment"></textarea>
                            <!-- description error -->
