                ...
                <div class="card-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group my-3">
                            ...
                            <textarea class="form-control text-editor <?php echo (isset($errors['description_error'])) ? "is-invalid" : "" ?>" name="description" id="description" rows="5" placeholder="Description"></textarea>
                            <!-- description error -->
