                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group my-3">
                            ...
                            <textarea class="form-control <?php echo (isset($errors['description_error'])) ? "is-invalid" : "" ?>" name="description" id="description" rows="5" placeholder="Description"></textarea>
                            <!-- description error -->
                        ...
                        <div class="form-group my-3">
                            ...
                            <input type="text" name="icon" class="form-control <?php echo (isset($errors['icon_error'])) ? "is-invalid" : "" ?>" id="icon" placeholder="Ex : bxl-dribbble">
                        ...
                        <div class="form-group my-3">
                            ...
                            <select name="box_color" id="box_color" class="form-select <?php echo (isset($errors['cox_color_error'])) ? "is-invalid" : "" ?>">
