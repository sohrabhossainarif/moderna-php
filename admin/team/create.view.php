                ...
                <div class="card-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control <?php echo (isset($errors['name_error'])) ? "is-invalid" : "" ?>" id="name" placeholder="Name" autofocus>
                            <!-- name error -->
                        ...
                        <div class="form-group my-3">
                            ...
                            <input type="text" name="designation" class="form-control <?php echo (isset($errors['designation_error'])) ? "is-invalid" : "" ?>" id="designation" placeholder="Designation">
                            <!-- designation error -->
                        ...
                        <div class="form-group my-3">
                            ...
                            <textarea type="text" name="description" class="form-control <?php echo (isset($errors['description_error'])) ? "is-invalid" : "" ?>" id="description" placeholder="Description" rows="5"></textarea>
                            <!-- description error -->
                        ...
                        <div class="form-group my-3">
                            ...
                            <input type="text" name="facebook" class="form-control <?php echo (isset($errors['facebook_error'])) ? "is-invalid" : "" ?>" id="facebook" placeholder="Facebook">
                            <!-- facebook error -->
                        ...
                        <div class="form-group my-3">
                            ...
                            <input type="text" name="twitter" class="form-control <?php echo (isset($errors['twitter_error'])) ? "is-invalid" : "" ?>" id="twitter" placeholder="Twitter">
                            <!-- twitter error -->
                        ...
                        <div class="form-group my-3">
                            ...
                            <input type="text" name="instagram" class="form-control <?php echo (isset($errors['instagram_error'])) ? "is-invalid" : "" ?>" id="instagram" placeholder="Instagram">
                            <!-- instagram error -->
                        ...
                        <div class="form-group my-3">
                            ...
                            <input type="text" name="linkedin" class="form-control <?php echo (isset($errors['linkedin_error'])) ? "is-invalid" : "" ?>" id="linkedin" placeholder="Linkedin">
                            <!-- linkedin error -->
